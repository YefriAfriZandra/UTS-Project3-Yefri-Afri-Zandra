...
<div class="col-lg-6 mb-5">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Entri Admin Pembayaran</h1>
</div>
<form method="post" action="/usersPembayaran" enctype="multipart/form-data">
    @csrf

      <div class="mb-2">
        <label for="nip_peg_pem" class="form-label">NIP</label>
        <input type="text" class="form-control @error('nip_peg_pem') is-invalid @enderror" name="nip_peg_pem" value="{{ old('nip_peg_pem')}}">
        @error('nip_peg_pem')
