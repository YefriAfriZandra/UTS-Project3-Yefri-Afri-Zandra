...
<form method="post" action="/nilai" enctype="multipart/form-data">
    ...
    <div class="mb-2">
      ...
      <input type="number" step="0.01" class="form-control @error('nilai_tugas') is-invalid @enderror" name="nilai_tugas" value="{{ old('nilai_tugas')}}">
      @error('nilai_tugas')
      <div class="invalid-feedback">
          {{ $message }}
      </div>
    ...
    <div class="mb-2">
      ...
      <input type="number" step="0.01" class="form-control @error('nilai_uts') is-invalid @enderror" name="nilai_uts" value="{{ old('nilai_uts')}}">
      @error('nilai_uts')
      <div class="invalid-feedback">
          {{ $message }}
      </div>
    ...
    <div class="mb-2">
      ...
      <input type="number" step="0.01" class="form-control @error('nilai_uas') is-invalid @enderror" name="nilai_uas" value="{{ old('nilai_uas')}}">
      @error('nilai_uas')
      <div class="invalid-feedback">
          {{ $message }}
      </div>
    ...
    <div class="mb-2">
      ...
      <select class="form-select @error('nilai_kepribadian') is-invalid @enderror" name="nilai_kepribadian">
          ...
          <option value="A" {{ old('nilai_kepribadian') == 'A' ? 'selected' : '' }}>A</option>
          <option value="B" {{ old('nilai_kepribadian') == 'B' ? 'selected' : '' }}>B</option>
          <option value="C" {{ old('nilai_kepribadian') == 'C' ? 'selected' : '' }}>C</option>
          <option value="D" {{ old('nilai_kepribadian') == 'D' ? 'selected' : '' }}>D</option>
          <option value="E" {{ old('nilai_kepribadian') == 'E' ? 'selected' : '' }}>E</option>
      </select>
    ...
    <div class="mb-2">
      ...
      <input type="number" class="form-control @error('sakit') is-invalid @enderror" name="sakit" value="{{ old('sakit')}}">
      @error('sakit')
      <div class="invalid-feedback">
          {{ $message }}
      </div>
    ...
    <div class="mb-2">
      ...
      <input type="number" class="form-control @error('alfa') is-invalid @enderror" name="alfa" value="{{ old('alfa')}}">
      @error('alfa')
      <div class="invalid-feedback">
          {{ $message }}
      </div>
    ...
    <div class="mb-2">
      ...
      <input type="number" class="form-control @error('izin') is-invalid @enderror" name="izin" value="{{ old('izin')}}">
      @error('izin')
      <div class="invalid-feedback">
          {{ $message }}
      </div>
